...
<div class="flex px-10  justify-center">
    ...
    <div class="md:w-1/2 px-8  sm:px-16  ">
        ...
        <div>
            <p class="font-normal  leading-8 ">If you don't have an account registered <br> You can <a href=""
        ...
        <form action="/" id="login-form" method="post" class="flex flex-col gap-4">
            ...
            <div class="relative mt-16 border-b-2 border-black">
                ...
                <input
                    ...
                    <img class="absolute bottom-3" width="17" src="{{asset('images/icons/email.svg')}}" alt="email">
            </div>
            <div class="relative border-b-2 border-black">
                <label for="Password"  class="text-sm text-gray">Password</label>
                <input class="p-2 pl-6  focus:outline-none focus:border-transparent outline-none border-none w-full  text-sm"
            ...
            <a href="/forgotPassword"
                class="text-primary text-[12px]/[18px]  text-end m-0">Forgot password ?</a>
            <button type="submit" id="loginbutton"
                class="bg-pink rounded-full w-full text-white py-2 hover:scale-105 duration-300 shadow-sm">
