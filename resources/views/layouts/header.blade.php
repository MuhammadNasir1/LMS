...
<body>
    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        <div class="flex  justify-center mt-[31px]">
            <a href="/dashboard"> <img src="{{ asset('images/sidebarlogo.svg') }}" alt="logo"></a>
        </div>
            ...
            <ul class="space-y-2  pl-3 pr-6 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2 bg-white rounded-lg text-slate-500">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Level</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Page</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Word</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Student's Recordings </span>
                    </a>
                </li>
                <li>
                    <a href="#"
                ...
                <li>
                    ...
                    <ul id="dropdown-example1" class="hidden py-2 space-y-2 bg-white text-slate-500 rounded-lg ">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Lms
                                Reports</a>
                        </li>
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Students
                                Reports</a>
                        </li>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Taining Videos</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Permission Page</span>
                    </a>
                </li>
                <li>
                    <a href="#"
