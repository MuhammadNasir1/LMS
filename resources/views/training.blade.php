                            ...
                            <td class="flex gap-5">
                                ...
                                @if ($permissions['delete'])
                                    <button data-modal-target="deleteData" data-modal-toggle="deleteData"
                                        class="delButton" delId="{{ $training->id }}">
                                ...
                                @if ($permissions['update'])
                                    <a href="../editTraining/{{ $training->id }}"> <button type="button"
                                ...
                                <a class="cursor-pointer" data-modal-target="videodetails{{ $i }}"
                                    data-modal-toggle="videodetails{{ $i }}"><svg width="36"
                                        ...
                                        <div class="flex flex-col gap-5  mt-4  pb-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center justify-end  mt-5">
                                                    ...
                                                    <div class="w-[200px]  ">
                                                        <p class="text-[14px] text-[#323C47]">{{ $training->date }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-end  mt-5">
    ...
    <div class="relative p-4 w-full max-w-7xl max-h-full ">
        @if (isset($trainingData))
            <form id="trainingForm" enctype="multipart/form-data" method="post"
                url="../updateTraining/{{ $trainingData->id }}">
            @else
        @endif
        <form id="trainingForm" enctype="multipart/form-data" method="post" url="../addtraining">
            @csrf
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700  ">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-[100px_minmax(100px,_1fr)]  my-6  ">
                            ...
                            <textarea class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[85px] text-[14px]" name="description"
                                id="description" placeholder="@lang('lang.Enter_Description')">{{ $trainingData->description ?? '' }}</textarea>
                        </div>
                ...
                <div class="flex justify-end ">
                    <button class="bg-secondary text-white py-2 px-6 my-4 rounded-[4px]  mx-6  font-semibold">
                        ...
                        <div id="text">
                            @lang(!isset($trainingData) ? 'lang.Add' : 'lang.Update')
                        </div>
